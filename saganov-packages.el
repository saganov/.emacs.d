...
(setq el-get-sources
      '((:name package
        ...
        (:name color-theme
               :after (lambda()
                (setq custom-theme-load-path "color-theme-zenburn")
                (load "color-theme-zenburn/color-theme-zenburn")
                (color-theme-zenburn)
;;;;                (autoload 'color-theme-zenburn "color-theme-zenburn" "" t)
                ))
        ))
...
(setq my-packages
      (append
       '(el-get php-mode-improved auto-complete sicp openwith cssh switch-window emacschrome edit-server vkill google-maps nxhtml xcscope yasnippet)
